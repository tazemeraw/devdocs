...
const updateTextLink = (node, index, parent) => {
    ...
    console.warn(`The {tracker ${issueNumber}} syntax has been deprecated. Simply use ${issueNumber}`);
...
const updateInlineLink = (node, index, parent) => {
    ...
    console.warn(`The {tracker}\`${issueNumber}\` syntax has been deprecated. Simply use ${newValue}`);
